...
export default function SMNavbar() {
    return (
        ...
        <div className="fixed w-full bottom-0 flex-col place-items-stretch justify-center text-4xl gap-5 bg-black shadow-black shadow-2xl flex min-w-max">
            ...
            <div className="borde py-3 flex gap-1 shadow-xl rounded-md items-center justify-center">
                ...
                <div className="group relative px-4 cursor-pointer">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full hover:text-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24" width="24">
                            <g>
                                <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="1.5" stroke="currentColor" d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z"></path>
                    ...
                    <span className="absolute -top-8 -translate-x-[50%] z-20 origin-left scale-0 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium shadow-md transition-all duration-300 ease-in-out group-hover:scale-100">
                        Settings
                    </span>
                </div>
            </div>
