...
import {
    PortfolioReview,
} from "./PortfolioReviewInterfaces";
import {
    Portfolio
...
const RequestsButton: React.FC<RequestsButtonProps> = ({ commentType, portfolio, petition }) => {
    ...
    const onSubmit = handleSubmit(async (data) => {
        if (commentType === 1 && petition) {
            ...
            await putRequest(ClientReviewRoutes.PRIVATE, petition.id, pullRequest)
            ...
            await postRequest(ClientReviewRoutes.PRIVATE, pullRequest)
        }
